#!/usr/bin/env python3
"""
CLI Simple para el Sistema de Inventario Inteligente
...
from inventario.models import Product, Sale, Supplier, Category, InventoryAlert
from inventario.ml_services import DemandPredictionService, ReorderSuggestionService, TrendAnalysisService
