...
from productos.models import Product, Sale, PurchaseOrder, InventoryAlert, Supplier, Category


class Command(BaseCommand):
    help = "Elimina datos de ejemplo (productos, ventas, órdenes, alertas) y borra modelos en modelos_ia."
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--only-models",
            action="store_true",
            help="Solo elimina archivos de modelos en la carpeta modelos_ia",
        )
    ...
    def _clear_ml_models(self) -> int:
        ...
        models_dir = os.path.join(settings.BASE_DIR, 'modelos_ia')
